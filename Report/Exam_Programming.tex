...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Images/ic_effect.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Images/unsqueeze.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Images/demo_forward_model_overdamped/summary.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Images/demo_forward_model_criticallydamped/summary.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Images/demo_forward_model_underdamped/summary.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{Images/demo_forward_model_underdamped/analytic_solution.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{Images/demo_forward_model_underdamped/predicted_solution.png}
    \caption{Predicted solution for the underdamped case.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Images/demo_forward_model_underdamped/epoch_snapshots.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Images/demo_forward_model_underdamped/losses.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Images/demo_forward_model_underdamped_extrapblind/summary.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Images/demo_forward_model_underdamped_ML/summary.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Images/demo_forward_model_underdamped/predicted_solution.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Images/demo_forward_model_hyperparameters/low_complexity/predicted_solution.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Images/demo_forward_model_hyperparameters/high_lr/predicted_solution.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Images/demo_forward_model_hyperparameters/low_lr/predicted_solution.png}
    \caption{Predicted solution with $lr=0.05$.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Images/demo_forward_model_hyperparameters/large_phys/predicted_solution.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Images/demo_forward_model_hyperparameters/large_phys_no_extrap/predicted_solution.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Images/demo_forward_model_hyperparameters/large_phys_no_data/predicted_solution.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Images/demo_backward_model_overdamped/predicted_solution.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Images/demo_backward_model_overdamped/parameter_convergence.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Images/demo_backward_model_criticallydamped/predicted_solution.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Images/demo_backward_model_criticallydamped/parameter_convergence.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Images/demo_backward_model_underdamped/predicted_solution.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Images/demo_backward_model_underdamped/parameter_convergence.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Images/parameter_estimation_4/scatter_zeta_full.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Images/parameter_estimation_4/scatter_omega_0_full.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{Images/parameter_estimation_4/parameter_space_rmse_full.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Images/analytic_solutions_zeta_underdamped.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Images/analytic_solutions_zeta_overdamped.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Images/analytic_solutions_omega_underdamped.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Images/analytic_solutions_omega_overdamped.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Images/gauss_characteristics.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Images/gauss_ic.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Images/gauss_t.png}
