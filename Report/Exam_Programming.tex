...
\textbf{Parameter} & \textbf{True value} & \textbf{Predicted value} \\
\midrule
\texttt{$\zeta$}             & $0.160$ & $1.950$ \\
\texttt{$\omega_0$}          & $0.171 rad/s$ & $1.961 rad/s$   \\
\bottomrule
