...
For now, these hyperparameters are chosen because they are observed to give good results. Section \ref{ch:hyperparameters_DHO} will give a more quantitative analysis of the effect of the hyperparameters. For brevity, I will only show the summary plots. All generated plots can be found in the \verb|outputs| directory
